...
void runTests() {
    ...
    cout << "\n" << setw(80) << "Bubble Sorted: "; BubbleSort(arr1); show(arr1); cout  << endl;

    cout << setw(80) << "Original Array 2: "; show(arr2);
    cout << "\n" << setw(80) << "Selection Sorted (Descending): "; sort(arr2); show(arr2); cout << endl;

    cout << setw(80) << "Original Array 3: "; show(arr3);
    cout << "\n" << setw(80) << "Insertion Sorted (Descending): "; sort(arr3); show(arr3); cout << endl;
    ...
    bool game = true;
    while (game) {
        cout << setw(80) << "\n\n"<<setw(80)<<"-- Reversing in k Groups --\n";
        cout << setw(80) << "1. Insert at end\n"<<setw(80)<<"2. Delete at end\n" << setw(80) << "3. Display List\n" << setw(80) << "4. Reverse in Groups\n" << setw(80) << "5. Check Empty\n" << setw(80) << "6. Exit\n" << setw(80) << "Choice: ";
        cin >> choice;
    ...
    cout << setw(80) << "Sorted: "; BubbleSort(arrf); show(arrf); cout << setw(80) << endl;

    cout << setw(80) << "=== FINAL: Sorting Chars ===\n";
    char arrc[] = { 'z', 'b', 'x', 'a' };
    cout << setw(80) << "Original: "; show(arrc);
    cout << setw(80) << "Sorted: "; sort(arrc); show(arrc); cout << setw(80) << endl;
    ...
    //       Binary Tree
    // =========================
    cout << setw(80) << "=== DEMO: Binary Search Tree ===\n";
    BST<int> bst;
    ...
    // =========================
     cout << endl;
    cout << setw(80) << "=== DEMO: Graph ===\n";
    int n, start, end;
    cout << setw(80) << "Enter Graph size: "; cin >> n;
    while (n <= 0) {
        cout << "\n" << setw(80)<<"Invalid. Enter again: "; cin >> n;
    }
    Graph<int> g(n);

    for (int i = 0; i < n; i++) {
        cout << setw(80) << "Edge " << i + 1 << ": "<<endl;
        cout << setw(80) << "Enter Start: "<<endl;
        cin >> start ;
        cout << setw(80) << "Enter End: " << endl;
        cin >> end;
        g.addEdge(start, end);
    }
